...
<body>
	...
	<h1 style="color: blue; font-size: 40px;" align="center">THIS IS MINE AND I AM THE CODER</h1>
	<h1 style="color: orange; font-size: 40px;" align="center">I am a DevOps engineer with infinite skills</h1>
